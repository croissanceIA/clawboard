...
import type { TasksProps, TabId } from '../types'
...
const TABS: {
  ...
  { id: 'tasks', label: 'Tasks', icon: <LayoutGrid className="size-4" />, countKey: 'cronJobs' },
  { id: 'templates', label: 'Templates', icon: <Blocks className="size-4" />, countKey: 'templates' },
  { id: 'schedules', label: 'Schedules', icon: <CalendarClock className="size-4" />, countKey: 'cronJobs' },
  { id: 'pre-instructions', label: 'Pre-instructions', icon: <FileText className="size-4" /> },
  ...
  return (
    <div className="px-6 py-8 sm:px-8 sm:py-10">
      <div className="mb-8">
        ...
        <p className="mt-1 text-sm text-zinc-400 dark:text-zinc-500">Manage your scheduled tasks, templates, and execution history.</p>
      </div>
