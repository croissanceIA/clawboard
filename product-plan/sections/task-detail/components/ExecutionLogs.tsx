    ...
    <div className="rounded-xl border border-zinc-200 bg-white dark:border-zinc-800 dark:bg-zinc-900">
      ...
      <div className="p-4">
        <div className="mb-4 flex flex-wrap gap-4 text-xs text-zinc-500 dark:text-zinc-400">
          ...
          <span className="inline-flex items-center gap-1"><Cpu className="size-3" />{activeRun.promptTokens?.toLocaleString() ?? '—'} / {activeRun.completionTokens?.toLocaleString() ?? '—'} tokens</span>
