        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4 backdrop-blur-sm">
          <div className="w-full max-w-lg rounded-2xl border border-zinc-200 bg-white shadow-2xl dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <div className="max-h-[60vh] space-y-4 overflow-y-auto px-6 py-5">
              ...
              <label className="block"><span className="mb-1 block text-xs font-medium text-zinc-700 dark:text-zinc-300">Pré-instructions <span className="text-zinc-400">(optionnel)</span></span><textarea value={form.preInstructions} onChange={(e) => setForm({ ...form, preInstructions: e.target.value })} rows={2} className="w-full rounded-lg border border-zinc-200 bg-white px-3 py-2 text-sm text-zinc-900 focus:border-blue-300 focus:outline-none focus:ring-2 focus:ring-blue-100 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-100 dark:focus:border-blue-700 dark:focus:ring-blue-950/50" placeholder="Texte ajouté avant les instructions..." /></label>
