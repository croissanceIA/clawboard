  ...
  return (
    <div>
      <div className="mb-3 flex items-center justify-between">
        <h2 className="text-sm font-medium text-zinc-900 dark:text-zinc-100">État des connexions</h2>
        <button
          onClick={onRecheckStatuses}
          className="flex items-center gap-1.5 rounded-lg px-2.5 py-1.5 text-xs font-medium text-zinc-400 transition-colors hover:bg-zinc-100 hover:text-zinc-600 dark:hover:bg-zinc-800 dark:hover:text-zinc-300"
        >
        ...
        <div className="divide-y divide-zinc-100 dark:divide-zinc-800">
          {statuses.map((item) => (
            <div key={item.id} className="flex items-center gap-3 px-5 py-3.5">
              ...
              <span className="hidden shrink-0 text-[10px] text-zinc-300 sm:block dark:text-zinc-600">
